...
{
   if(desplazamiento_x - 0.5 > limiteDesplazamientoX_2)
      desplazamiento_x -= 0.5;
   else
      desplazamiento_x = limiteDesplazamientoX_2;
...
{
   if(desplazamiento_y - 0.5 > limiteDesplazamientoY_2)
      desplazamiento_y -= 0.5;
   else
      desplazamiento_y = limiteDesplazamientoY_2;
...
{
   if(desplazamiento_z - 0.5 > limiteDesplazamientoZ_2)
      desplazamiento_z -= 0.5;
   else
      desplazamiento_z = limiteDesplazamientoZ_2;
